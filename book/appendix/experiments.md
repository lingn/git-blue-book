...
- 普通/no-checkout/bare/mirror/empty clone 初态，以及源 local config、hook 和未跟踪文件不随普通 clone 传输；
...
- 分离 HEAD 的 CI 候选、合并提交父节点、可重复源码归档、证据清单、逐环境 promotion attempt、部分提升拒绝和部署副本摘要恢复。
