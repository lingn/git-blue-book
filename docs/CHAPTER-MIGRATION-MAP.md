...
| 当前文件 | v2 目标 | 动作 |
| --- | --- | --- |
| `book/part-5/README.md` | `book/part-07/README.md` | 已于 2026-09-13 完成主线迁移；旧目录保留 `legacy-redirect` 兼容入口 |
| `book/part-5/01-decision-matrix.md` | `book/part-07/01-state-and-sharing-matrix.md` | 已于 2026-09-05 迁移；旧页保留 `legacy-redirect` 兼容入口 |
| `book/part-5/02-restore-worktree.md` | `book/part-07/02-restore-worktree.md` | 已于 2026-09-05 迁移；旧页保留 `legacy-redirect` 兼容入口 |
...
| `book/part-5/08-public-history.md` | `book/part-07/09-public-history-policy.md` | 已于 2026-09-06 迁移；旧页保留 `legacy-redirect` 兼容入口 |
...
| `book/part-5/13-rewrite-commit-playbook.md` | `book/part-07/04-amend-one-commit.md` | 已于 2026-09-05 收束迁移；旧页保留 `legacy-redirect` 兼容入口 |
| `book/part-5/14-remote-history-rewrite.md` | `book/part-07/14-remote-history-rewrite.md` | 已于 2026-09-13 迁移；旧页保留 `legacy-redirect` 兼容入口 |
...
| `book/part-6/01-stash.md` | `book/part-02/11-stash.md` | 已于 2026-09-05 迁移；旧页保留 `legacy-redirect` 兼容入口 |
| `book/part-6/02-worktree.md` | `book/part-02/12-multiple-worktrees.md` | 已于 2026-09-05 迁移；旧页保留 `legacy-redirect` 兼容入口 |
...
| `book/part-07/05-interactive-rebase.md` | `book/part-5/06-interactive-rebase.md` | 已于 2026-09-05 迁入，2026-09-13 完成第一轮跨章去重；承担交互式 todo、重排/拆分、edit-todo、exec 和序列验证，通用冲突与中止改为引用下一章 |
...
| `book/part-07/11-reset.md` | `book/part-5/10-reset.md` | 已于 2026-09-05 迁入，2026-09-13 完成第一轮跨章去重；承担 soft/mixed/hard、路径形式、未跟踪边界、分离 HEAD 和恢复入口，候选验证与事故编排改为链接后两章 |
...
| `book/part-07/14-remote-history-rewrite.md` | `book/part-5/14-remote-history-rewrite.md` | 已于 2026-09-13 迁入；承担 ahead/behind、forced-update、远程跟踪 reflog、补丁等价、rebase abort 和恢复路线 |
...
| `book/part-05/02-clone-and-initial-state.md` | `book/part-4/02-clone.md` | 新写并承担普通、显式 branch/single-branch、empty、no-checkout、bare、mirror、本地复制优化、非 Git 状态缺口、外部依赖、失败目录和 clone 后验收 |
