...
| `book/part-6/06-release.md` | `book/part-08/05-release-refs-and-artifacts.md`、`book/part-08/06-deploy-and-rollback.md` | 拆分并实质重写 |
...
| `book/part-6/09-protected-branches.md` | `book/part-06/06-required-checks-and-merge-queues.md`、`book/part-06/08-protected-refs.md`、`book/part-12/04-rules-and-exceptions.md` | 拆分；当前稿保留控制面模型 |
| `book/part-6/10-troubleshooting.md` | `book/part-13/README.md`、`book/part-13/01-evidence-first.md` | 拆分后全面扩写 |
| `book/part-6/11-ci-evidence-chain.md` | `book/part-08/03-source-artifact-deployment-evidence.md` | 过渡新增；作为第八篇证据链权威稿 |
| `book/part-6/12-ci-triggers-merge-queue.md` | `book/part-06/06-required-checks-and-merge-queues.md`、`book/part-08/01-triggers-and-checkout.md`、`book/part-08/02-candidate-commits.md` | 过渡新增后拆分；状态机与提交图保持同一权威来源 |
